...
namespace NGP.Framework.DataAccess
{
    ...
    /// 工作单元仓储
    /// </summary>
    public class MysqlRepository : UnitRepository
    {
        #region Ctor
        /// <summary>
        /// ctor
        ...
        protected override void SetParameters(IDbCommand dbCommand, IDictionary<string, object> parameters)
        {
            ...
            foreach (var parameter in parameters)
            {
                ...
                {
                    dbCommand.Parameters.Add(new MySqlParameter(parameter.Key, parameter.Value));
                    continue;
                }

                dbCommand.Parameters.Add(new MySqlParameter(parameter.Key, DBNull.Value));
            }
        }
    }
}
